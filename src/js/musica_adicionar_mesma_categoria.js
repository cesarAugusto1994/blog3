    ...
    handleSubmit: function (e) {
        ...
        */
        ...
        $.ajax({
            ...
            data: {
                itens: [
                    {nome : nome1, numero : numero1, tonalidade : tonalidade1, categoria : categoria},
                    {nome : nome2, numero : numero2, tonalidade : tonalidade2, categoria : categoria},
                    {nome : nome3, numero : numero3, tonalidade : tonalidade3, categoria : categoria},
                    {nome : nome4, numero : numero4, tonalidade : tonalidade4, categoria : categoria},
                    {nome : nome5, numero : numero5, tonalidade : tonalidade5, categoria : categoria},
                    {nome : nome6, numero : numero6, tonalidade : tonalidade6, categoria : categoria},
                    {nome : nome7, numero : numero7, tonalidade : tonalidade7, categoria : categoria},
                    {nome : nome8, numero : numero8, tonalidade : tonalidade8, categoria : categoria},
                    {nome : nome9, numero : numero9, tonalidade : tonalidade9, categoria : categoria},
                    {nome : nome10, numero : numero10, tonalidade : tonalidade10, categoria : categoria}
                ],
            },
            cache: false,
        ...
        return (
            <Container>
                <form className="form-horizontal" method="POST" onSubmit={this.handleSubmit}>
                    ...
                    <p className="control is-expanded">
                        <div className="select is-fullwidth">
                            <select id="categoria" name="categoria" ref="categoria" defaultValue={this.props.categoria} >
...
if (document.getElementById("musica-adicionar-mesma-categoria")) {
    ...
    ReactDOM.render(<Render categoria={categoria}/>, document.getElementById('musica-adicionar-mesma-categoria'));
}