 ...
 */
class Version20170522170529 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE grupo_musica_situacao (id INT AUTO_INCREMENT NOT NULL, label VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE grupo_usuarios (id INT AUTO_INCREMENT NOT NULL, grupo_id INT DEFAULT NULL, usuario_id INT DEFAULT NULL, administrador TINYINT(1) NOT NULL, INDEX IDX_461BB8379C833003 (grupo_id), INDEX IDX_461BB837DB38439E (usuario_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE grupo_musicas (id INT AUTO_INCREMENT NOT NULL, grupo_id INT DEFAULT NULL, musica_id INT DEFAULT NULL, situacao_id INT DEFAULT NULL, INDEX IDX_74CCCD019C833003 (grupo_id), INDEX IDX_74CCCD0199E6F854 (musica_id), INDEX IDX_74CCCD0195FC38A6 (situacao_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE notificacao (id INT AUTO_INCREMENT NOT NULL, usuario_id INT DEFAULT NULL, mensagem LONGTEXT NOT NULL, visualizada TINYINT(1) NOT NULL, data_hora DATETIME NOT NULL, INDEX IDX_5ACD9386DB38439E (usuario_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE grupo_musicas ADD CONSTRAINT FK_74CCCD0195FC38A6 FOREIGN KEY (situacao_id) REFERENCES grupo_musica_situacao (id)');
        $this->addSql('ALTER TABLE notificacao ADD CONSTRAINT FK_5ACD9386DB38439E FOREIGN KEY (usuario_id) REFERENCES usuarios (id)');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE grupo_musicas DROP FOREIGN KEY FK_74CCCD0195FC38A6');
        ...
        $this->addSql('DROP TABLE grupo_musica_situacao');
