 ...
 */
class Version20161015185624 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE anexo_tags (id INT AUTO_INCREMENT NOT NULL, anexo_id INT DEFAULT NULL, tag_id INT DEFAULT NULL, INDEX IDX_39BC332C9348664 (anexo_id), INDEX IDX_39BC332BAD26311 (tag_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE email_confirmation (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, email VARCHAR(80) NOT NULL, uuid VARCHAR(50) NOT NULL, created DATETIME NOT NULL, confirmed DATETIME DEFAULT NULL, status SMALLINT NOT NULL, INDEX IDX_1D2EF46FA76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE log (id INT AUTO_INCREMENT NOT NULL, usuario_id INT DEFAULT NULL, mensagem VARCHAR(255) NOT NULL, rota VARCHAR(255) DEFAULT NULL, cadastro DATETIME NOT NULL, INDEX IDX_8F3F68C5DB38439E (usuario_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE musica (id INT AUTO_INCREMENT NOT NULL, categoria_id INT DEFAULT NULL, usuario_id INT DEFAULT NULL, numero INT DEFAULT NULL, nome VARCHAR(255) NOT NULL, tom VARCHAR(255) NOT NULL, letra LONGTEXT DEFAULT NULL, letra_original LONGTEXT DEFAULT NULL, cadastro DATETIME NOT NULL, novo TINYINT(1) NOT NULL, ativo TINYINT(1) NOT NULL, INDEX IDX_7E7344EF3397707A (categoria_id), INDEX IDX_7E7344EFDB38439E (usuario_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE usuarios (id INT AUTO_INCREMENT NOT NULL, nome VARCHAR(60) NOT NULL, nickname VARCHAR(255) NOT NULL, email VARCHAR(90) NOT NULL, password VARCHAR(50) NOT NULL, avatar VARCHAR(255) DEFAULT NULL, roles VARCHAR(60) NOT NULL, cadastro DATETIME NOT NULL, ativo SMALLINT DEFAULT 0 NOT NULL, UNIQUE INDEX UNIQ_EF687F2E7927C74 (email), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE config (id INT AUTO_INCREMENT NOT NULL, nome VARCHAR(255) NOT NULL, subtitulo VARCHAR(255) DEFAULT NULL, background VARCHAR(255) DEFAULT NULL, envia_email TINYINT(1) DEFAULT \'0\' NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE widgets (id INT AUTO_INCREMENT NOT NULL, nome VARCHAR(255) NOT NULL, decricao VARCHAR(255) DEFAULT NULL, url VARCHAR(255) DEFAULT NULL, imagem VARCHAR(255) NOT NULL, role VARCHAR(255) NOT NULL, ativo TINYINT(1) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
