 ...
 */
class Version20161110093722 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE album (id INT AUTO_INCREMENT NOT NULL, musica_id INT DEFAULT NULL, label VARCHAR(255) NOT NULL, INDEX IDX_39986E4399E6F854 (musica_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
