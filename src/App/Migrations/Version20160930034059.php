 ...
 */
class Version20160930034059 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE musica (id INT AUTO_INCREMENT NOT NULL, categoria_id INT DEFAULT NULL, usuario_id INT DEFAULT NULL, numero INT NOT NULL, nome VARCHAR(255) NOT NULL, tom VARCHAR(255) NOT NULL, letra LONGTEXT NOT NULL, letra_original LONGTEXT DEFAULT NULL, cadastro DATETIME NOT NULL, ativo TINYINT(1) NOT NULL, INDEX IDX_7E7344EF3397707A (categoria_id), INDEX IDX_7E7344EFDB38439E (usuario_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE musica_anexos (id INT AUTO_INCREMENT NOT NULL, musica_id INT DEFAULT NULL, tipo_id INT DEFAULT NULL, usuario_id INT DEFAULT NULL, nome VARCHAR(255) NOT NULL, link_externo SMALLINT NOT NULL, link LONGTEXT NOT NULL, cadastro DATETIME NOT NULL, ativo TINYINT(1) NOT NULL, INDEX IDX_849BE9F099E6F854 (musica_id), INDEX IDX_849BE9F0A9276E6C (tipo_id), INDEX IDX_849BE9F0DB38439E (usuario_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE usuarios (id INT AUTO_INCREMENT NOT NULL, nome VARCHAR(60) NOT NULL, email VARCHAR(90) NOT NULL, password VARCHAR(50) NOT NULL, roles VARCHAR(60) NOT NULL, cadastro DATETIME NOT NULL, ativo SMALLINT DEFAULT 0 NOT NULL, UNIQUE INDEX UNIQ_EF687F2E7927C74 (email), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
