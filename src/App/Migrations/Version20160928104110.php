 ...
 */
class Version20160928104110 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE musica (id INT AUTO_INCREMENT NOT NULL, categoria_id INT DEFAULT NULL, usuario_id INT DEFAULT NULL, numero INT NOT NULL, nome VARCHAR(255) NOT NULL, tom VARCHAR(255) NOT NULL, letra LONGTEXT NOT NULL, cadastro DATETIME NOT NULL, ativo TINYINT(1) NOT NULL, INDEX IDX_7E7344EF3397707A (categoria_id), INDEX IDX_7E7344EFDB38439E (usuario_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE config (id INT AUTO_INCREMENT NOT NULL, nome VARCHAR(255) NOT NULL, subtitulo VARCHAR(255) NOT NULL, background VARCHAR(255) NOT NULL, envia_email TINYINT(1) DEFAULT \'0\' NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
