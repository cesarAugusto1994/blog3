 ...
 */
class Version20170504163521 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE playlist_musicas (id INT AUTO_INCREMENT NOT NULL, musica_id INT DEFAULT NULL, usuario_id INT DEFAULT NULL, cadastro DATETIME NOT NULL, INDEX IDX_94FA54BC99E6F854 (musica_id), INDEX IDX_94FA54BCDB38439E (usuario_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE playlist (id INT AUTO_INCREMENT NOT NULL, usuario_id INT DEFAULT NULL, cadastro DATETIME NOT NULL, INDEX IDX_D782112DDB38439E (usuario_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE playlist_musicas ADD CONSTRAINT FK_94FA54BC99E6F854 FOREIGN KEY (musica_id) REFERENCES musica (id)');
