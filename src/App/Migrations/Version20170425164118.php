 ...
 */
class Version20170425164118 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE grupo (id INT AUTO_INCREMENT NOT NULL, nome VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE usuarios ADD grupo_id INT DEFAULT NULL, ADD cidade VARCHAR(255) NOT NULL, ADD uf VARCHAR(50) NOT NULL');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE usuarios DROP grupo_id, DROP cidade, DROP uf');
    }
}
