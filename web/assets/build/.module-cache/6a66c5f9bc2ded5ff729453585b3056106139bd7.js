            ...
            modal = (
                React.createElement(Modal, {title: "Add Schedule Entry"}, 
                    React.createElement("form", {className: "form-horizontal"}, 
                        ...
                        React.createElement("input", {type: "hidden", name: "id", id: "id"}), 


                        React.createElement("label", {htmlFor: "nome"}, "Nome"), 
                        React.createElement("input", {class: "input is-primary", type: "text", placeholder: "Nome", ref: "nome", name: "nome", id: "nome", required: true}), 
                            React.createElement("label", {htmlFor: "colecao"}, "Coleção"), 
                            React.createElement("select", {class: "input is-primary", name: "colecao", id: "colecao", ref: "colecao", required: true}, 
