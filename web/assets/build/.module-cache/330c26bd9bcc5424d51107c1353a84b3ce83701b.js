...
Image = React.createClass({displayName: "Image",
    render : function () {
        return (
            React.createElement("a", {href: this.props.categoriaUrl}, 
        ...
        return (
            React.createElement("figure", {className: "wow fadeInLeft animated portfolio-item", "data-wow-duration": "500ms", "data-wow-delay": "0ms"}, 
                React.createElement("div", {className: "img-wrapper"}, 
                    React.createElement(Image, {colecao: this.props.colecao, dirImg: this.props.dirImg, categoriaUrl: this.props.categoriaUrl})
                ), 
    ...
    render : function () {
        ...
        return (
            React.createElement("div", {className: "col-sm-4 col-xs-12"}, 
                React.createElement(Figure, {colecao: this.props.colecao, dirImg: this.props.dirImg, categoriaUrl: this.props.categoriaUrl})
            )
        )
    }
});
...
$(function () {
                ...
                React.createElement("span", null,  this.state.data.map(function (colecao) {
                    return (
                        React.createElement("div", {key: colecao.id}, 
                            React.createElement(BlockColecoes, {colecao: colecao, dirImg: dirImg, categoriaUrl: categoriaUrl})
                        )
                    )
                }) )
            )
    ...
    var categoriaUrl = $("#colecoes").attr("data-url");

    ReactDOM.render(
        React.createElement("div", null, 
            React.createElement(ColecoesList, {source: source, dirImg: dirImg, categoriaUrl: categoriaUrl})
        ),
