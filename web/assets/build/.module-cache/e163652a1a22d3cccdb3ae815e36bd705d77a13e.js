    ...
    render : function () {
        return (
            React.createElement("a", {href: "#"}, 
                React.createElement("img", {className: "img-responsive", value: "min-height: 160px; max-height: 160px; margin: auto;", src: "http://lorempixel.com/200/200/", alt: this.props.colecao.name})
            )
        )
    }
});
