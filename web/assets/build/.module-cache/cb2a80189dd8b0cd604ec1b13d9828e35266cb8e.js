    ...
    render : function () {
        return (
            React.createElement("a", {href: "#"}, 
                React.createElement("img", {className: "img-responsive", style: "min-height: 160px; max-height: 160px; margin: auto;", src: this.props.colecao.imagem, alt: this.props.colecao.name})
            )
        )
    }
});
