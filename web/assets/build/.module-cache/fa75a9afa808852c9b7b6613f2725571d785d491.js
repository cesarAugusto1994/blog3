    ...
    render : function () {
        return (
            React.createElement("a", {href: "#"}, 
                React.createElement("img", {style: "min-height: 160px; max-height: 160px; margin: auto;", src: "", class: "img-responsive", alt: this.props.colecao})
            )
        )
    }
});
...
BlockColecoes = React.createClass({displayName: "BlockColecoes",
    ...
    render : function () {
        ...
        return (
            React.createElement("div", {key: this.props.colecao.id, className: "col-sm-4 col-xs-12"}, 
